  ...
  return (
    <nav className="w-full fixed z-40">
      <div
        ...
        `}
      >
        <img className="h-4 lg:h-7" src="/images/logo.png" alt="neflix logo" />
        ...
        <div
          ...
          className="lg:hidden flex flex-row items-center gap-2 ml-8 cursor-default relative"
        >
          <p className="text-white text-sm">Explorer</p>
          <BsChevronDown
